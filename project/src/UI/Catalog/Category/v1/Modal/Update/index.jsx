...
const UpdateItemCategory = () => {
  ...
  return (
    <>
            <Transition.Root show={currentVisibleUpdateCategoryModal} as={Fragment}>
            <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={() => closeVisibleUpdateCategoryModal()}>
                <Transition.Child
                as={Fragment}
                    ...
                    <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6">
                        ...
                        <form onSubmit={handleUpdateCategory} className="space-y-8 divide-y divide-gray-200">
                            ...
                            <div className="mt-8 sm:mt-10 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                                ...
                                onClick={() => closeVisibleUpdateCategoryModal()}
                                ref={cancelButtonRef}
                                >
                                Отменить
                                </button>
