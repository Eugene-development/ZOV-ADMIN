...
const CreateItemCategory = () => {
  ...
  return (
    <>
            ...
            <Transition.Root show={currentVisibleCreateCategoryModal} as={Fragment}>
            <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={() => closeVisibleCreateCategoryModal()}>
                <Transition.Child
                as={Fragment}
                        ...
                        <form onSubmit={handleAddCategory} className="space-y-8 divide-y divide-gray-200">
                            ...
                            <div className="mt-8 sm:mt-10 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                                ...
                                <button
                                    ...
                                    onClick={() => closeVisibleCreateCategoryModal()}
                                    ref={cancelButtonRef}
                                    >
                                    Отменить
                                </button>
